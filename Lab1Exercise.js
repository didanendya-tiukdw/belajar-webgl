...
function setupEventListeners()
{
  ...
  m.addEventListener("change", changeColor);
}
...
function changeColor(event) {
    ...
    var colorName = event.srcElement.options[index].value;
...
function PreRenderScene() {
 ...
 function RenderScene() {
    ...
    // Set the drawing color to red (the default objectColor)
    ...
    urgl.drawSolidSphere(0.5, 200, 200);
